...
const teamMembers = [
  { name: "ნინო გიორგაძე", role: "დამფუძნებელი", description: "15 წელი ემიგრანტების დახმარებაში" },
  { name: "გიორგი მაისურაძე", role: "უძრავი ქონების აგენტი", description: "NYC ბაზრის ექსპერტი" },
  { name: "მარიამ ბერიძე", role: "თარჯიმანი", description: "სამედიცინო და იურიდიული თარგმანი" },
];
        ...
        <div className="container py-6 px-4 pb-24 lg:pb-8">
          ...
          <div className="bg-card rounded-2xl overflow-hidden border border-border mb-6 shadow-md">
            ...
            <div className="p-5 -mt-16 relative">
              ...
              ამ პერიოდის განმავლობაში მუდმივად ვინიშნავდით იმ სააგენტოებისა და
              დამსაქმებლების მონაცემებს, რომლებთანაც შეხება გვქონია. ვეძებდით სხვადასხვა
              ალტერნატიულ არხებს და ერთ-ერთი სერვისი, რომელსაც შემოგთავაზებთ,
              ვაკანსიების პორტალი იქნება, რომელიც მუდმივად განახლდება. ამ ვაკანსიების
              პროვაიდერები ჩვენ არ ვიქნებით, რაც იმას გულისხმობს, რომ ჩვენ დამსაქმებლები არ
              ვართ, მაგრამ ვიქნებით შუამავალი რგოლი თქვენსა და დამსაქმებელს შორის, რომ
              სასურველმა ვაკანსიამ და კადრმა ერთმანეთი იპოვნონ. ქართულად განთავსებული
              ვაკანსიების საძიებო სისტემით სარგებლობა, ცხადია, ჩვენთან სრულიად უფასოა, და
              მუდამ ასე იქნება.
              გარდა ამისა, საიტზე განთავსდება სხვადასხვა სერვისები, რომლებსაც
              შემოგთავაზებთ როგორც ჩვენ, ასევე ჩვენი პარტნიორი ორგანიზაციები. მაგალითად -
              თათია გამოცდილი თარჯიმანია, რომელიც დაგეხმარებათ სასამართლო, საემიგრაციო,
              სამედიცინო, სამსახურეობრივ თუ სხვა სახის ყოველდღიურ სათარგმნ ოპერაციებში.
              იგი უკვე მეოთხე წელია, თარჯიმნად მუშაობს და არაერთი მადლიერი ადამიანი ჰყავს
              როგორც ნიუ-იორკში, ასევე ახლომდებარე შტატებში. ლუკა კი უძრავი ქონების
              ლიცენზირებული აგენტია, რომელიც დაგეხმარებათ თქენთვის სასურველი კერძო
              სახლის, ბინის ან კომერციული ფართის ქირაობაში, ყიდვაში, გაქირავებასა და
              გაყიდვაში. რაც მთავარია, ნიუ-იორკის კანონის გათალისწინებით, ჩვენს მიერ
              მოწოდებულ გასაქირავებელ ბინებზე არ გადაიხდით ე.წ. “მესამე თვის” გადასახადს,
              რაც გულისხმობს დამატებით ერთი თვის ქირას, როდესაც მოქირავნე ერთი თვის ფულს
              უხდის აგენტს.
          ...
          <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl p-6 border border-primary/20 mb-6">
            ...
            <ul className="space-y-4">
              {[
                "ვართ ქართულენოვანი - ზუსტად გვესმით თქვენი საჭიროებები",
                "10 წელზე მეტი გამოცდილება ამერიკაში",
                "სწრაფი და პროფესიონალური მომსახურება",
                "ხელმისაწვდომი ფასები",
                "ათასობით კმაყოფილი კლიენტი"
              ].map((item, index) => (
